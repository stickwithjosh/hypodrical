...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Podcast.ga_code'
        db.add_column('podcast_podcast', 'ga_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Podcast.ga_code'
        db.delete_column('podcast_podcast', 'ga_code')
    ...
    models = {
        ...
        'podcast.podcast': {
            ...
            'explicit': ('django.db.models.fields.CharField', [], {'default': "'1'", 'max_length': '3', 'blank': 'True'}),
            'ga_code': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
